...
export default function GradeHeader({ gradeId }: GradeHeaderProps) {
  ...
  return (
    <section className="font-anek items-center justify-center p-2 mt-4 mb-8">
      <div className="flex flex-col md:flex-row items-center justify-center my-6 mb-12">
        <h2 className="text-4xl text-dark_brown dark:text-white text-center 2xl:text-5xl">{grade.title}</h2>


        <div className="relative flex font-anek mt-5 font-normal text-lg flex-col items-center justify-center text-center">
